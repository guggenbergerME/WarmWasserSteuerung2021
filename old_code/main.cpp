...
// AdresseNeu 0x28, 0x5F, 0x72, 0x81, 0xE3, 0x11, 0x3C, 0xBA
// AdresseAlt 0x28, 0xFF, 0x7F, 0x77, 0xA1, 0x16, 0x05, 0x40
...
*/
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_0")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_1")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_2")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_3")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_4")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_5")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_6")==0) {
    ...
    if (strcmp(topic,"Warmwasser/ww_relais_7")==0) {
